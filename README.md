...
This repository contains a reproducible, modular variant calling pipeline for Escherichia coli whole-genome sequencing (WGS) data.
The pipeline is designed to process paired-end Illumina reads, align them to the REL606 reference genome, and identify high-confidence SNPs 
and small indels.
------------------------------------------------------------------------------------------------------------------------------------------------
The workflow follows widely accepted best practices in bacterial genomics and is suitable for:

-Academic coursework and bioinformatics diplomas
-Research projects
...
3- second QC:
second round of QC to check the quality after trimming

4- Alignment:
Mapping reads to the REL606 reference genome using BWA-MEM
...
1- Sequencing Data:
-Paired-end FASTQ files (.fastq or .fastq.gz)

2- Reference Genome
-E. coli REL606 reference genome (FASTA)
-Corresponding annotation file (GFF)

------------------------------------------------------------------------------------------------------------------------------------------------
Output Files

All outputs are automatically generated under the results/ directory:
qc/ : fastq reports
...
conda activate ecoli-variant-calling
...
Yahia Maher Mohamed
Molecular Biologist | NGS & Bioinformatics
Egypt
------------------------------------------------------------------------------------------------------------------------------------------------
License:
